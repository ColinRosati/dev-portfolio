    ...
    return (
      <div className={styles.content}>
          ...
          <LinkTitle href={ 'about'} className={styles.navLink}>
            ...
            <Badge className={styles.btnSecondary} variant='secondary'>{props.countX}</Badge>
          </LinkTitle>
          <LinkTitle href={'work'} className={styles.navLink}>
            ...
            <Badge className={styles.btnSecondary} variant='secondary'>{props.countY}</Badge>
          </LinkTitle>
          <LinkTitle href={'contact'} className={styles.navLink}>
            ...
            <Badge className={styles.btnSecondary} variant='secondary'>{props.countZ}</Badge>
          </LinkTitle>
        </div>
    )
  }
