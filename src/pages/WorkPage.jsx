...
const WorkPage = () => {
  ...
  const ProjectBody = () => {
    ...
    return(
      <div>
        <WorkHead/>
        <Projects head={"Sensor Data visualization App"} link={"https://github.com/ColinRosati1/smart-steel-app"} linkTitle={"Sensor Data visualization App"} details={"Design, Development → React, Highcharts, HTML, NPM, Jest, Python, Flask"}/>
        <Projects head={"Hotel finder App"} link={"https://github.com/ColinRosati1/hotelpirates"} linkTitle={"Hotel Finder App"} details={"Design, Development → ES6, HTML, Webpack, Jest, Puppeteer"}/>
